package com.example.CassandraWithSpringBoot.controller;

import com.example.CassandraWithSpringBoot.model.Employee;
import com.example.CassandraWithSpringBoot.repostories.EmployeeRepository;
...
public class EmployeeController {
    ...
    public ResponseEntity<Object> getEmployeeById(@PathVariable("id") Integer id, @RequestBody Employee employee) {
